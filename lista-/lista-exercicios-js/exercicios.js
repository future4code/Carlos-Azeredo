...
function calculaAreaRetangulo(numero1,numero2) {
   // implemente sua lógica aqui
...
const pergPeso = Number(prompt('Insira seu peso')) 
const pergAltura = Number(prompt('Insira a altura!'))

console.log('IMC é: ', calculaIMC(pergPeso, pergAltura))
